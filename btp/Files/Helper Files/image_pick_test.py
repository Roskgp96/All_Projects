...
def image_pick():
	...
	with open('test.txt','r') as file:
		for line in file:
			...
			print(item)
			flag=0
			for file in glob.iglob('/home/roshan/Documents/btp/Training_Dataset/image_dataset/*.jpg'):
...
def imag(lis):
	...
	count3=0
	for item in lis:
		for file in glob.iglob('/home/roshan/Documents/btp/Training_Dataset/test_images/*.jpg'):
			x=re.match(r"/\w*/\w*/\w*/\w*/\w*_\w*/\w*_\w*/(.*)",file)
			name=x.group(1)
			print(item)
			if name==item:
