...
dataset_path      = "/home/somnath/synthetic_driving/data"
...
def Dataset():
    ...
    train_filepaths = [ dataset_path + train_path + "/" + fp for fp in train_filepaths]
    test_filepaths = [ dataset_path + test_path + "/" + fp for fp in test_filepaths]
